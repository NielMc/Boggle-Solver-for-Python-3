...
class TestBoggle(unittest.TestCase):
    ...
    def test_can_create_an_empty_grid(self):
        ...
        self.assertEqual(len(grid), 0, "No empty grid")

    def test_grid_size_is_width_times_height(self):
        grid = boggle.make_grid(2, 3)
        self.assertEqual(len(grid), 6, "grid not width by height")
    ...
    def test_grid_is_filled_with_letters(self):
        ...
        for L in grid.values():
            self.assertTrue(L in ascii_uppercase, "No L in grid")
    ...
    def test_load_dictionary(self):
        dictionary = boggle.get_dictionary('C:\\Users\\user\\Documents\\Stream2\\Projects\\Boggle\\bogwords.txt')
